...
checkpoint = ModelCheckpoint('./models/VGG_model_best.h5', verbose=1, monitor='val_img_acc',save_best_only=True, mode='auto')  
#checkpoint = ModelCheckpoint('./models/VGG_model_1.h5')
...
history = final_model.fit_generator(custom_generator(train_iterator),
                          steps_per_epoch=209222//128,
                          epochs=150, validation_data=custom_generator(test_iterator),
                          validation_steps=40000//128,
                          verbose=2,
                          shuffle=True,
...
#with open('./trainHistoryDict/hist.pickle', 'wb') as file_pi:
